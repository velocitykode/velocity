...
// by the Providers, Middleware, Routes, and Commands chain methods. The types
...
// write *velocity.Routing, *velocity.MiddlewareStack, velocity.RouteProvider,
...
// third-party service provider that needs to embed or reference these

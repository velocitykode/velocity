...
func TestNewRedisStore(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "returns error as not implemented",
			prefix:   "app",
			host:     "localhost",
			port:     6379,
			password: "",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := NewRedisStore(tt.prefix, tt.host, tt.port, tt.password, tt.database)
			if (err != nil) != tt.wantErr {
...
func TestRedisStore_Get(t *testing.T) {
	t.Run("returns false as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		_, found := store.Get("key")
		if found {
			t.Error("Get() should return false for unimplemented driver")
		}
	})
}

func TestRedisStore_GetString(t *testing.T) {
	t.Run("returns empty string and false as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		val, found := store.GetString("key")
		if found {
			t.Error("GetString() should return false for unimplemented driver")
		}
		if val != "" {
...
func TestRedisStore_Put(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		err := store.Put("key", "value", time.Hour)
		if err == nil {
			t.Error("Put() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Forever(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		err := store.Forever("key", "value")
		if err == nil {
			t.Error("Forever() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Forget(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		err := store.Forget("key")
		if err == nil {
			t.Error("Forget() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Flush(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		...
		err := store.Flush()
		if err == nil {
			t.Error("Flush() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Increment(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		_, err := store.Increment("key", 1)
		if err == nil {
			t.Error("Increment() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Decrement(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		_, err := store.Decrement("key", 1)
		if err == nil {
			t.Error("Decrement() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Remember(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		_, err := store.Remember("key", time.Hour, func() interface{} { return "value" })
		if err == nil {
			t.Error("Remember() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_RememberForever(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		_, err := store.RememberForever("key", func() interface{} { return "value" })
		if err == nil {
			t.Error("RememberForever() should return error for unimplemented driver")
		}
	})
}

func TestRedisStore_Many(t *testing.T) {
	t.Run("returns empty map as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		result := store.Many([]string{"key1", "key2"})
		if len(result) != 0 {
			t.Errorf("Many() returned non-empty map: %v", result)
		}
	})
}
...
func TestRedisStore_PutMany(t *testing.T) {
	t.Run("returns error as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		err := store.PutMany(map[string]interface{}{"key": "value"}, time.Hour)
		if err == nil {
			t.Error("PutMany() should return error for unimplemented driver")
		}
	})
}
...
func TestRedisStore_Has(t *testing.T) {
	t.Run("returns false as not implemented", func(t *testing.T) {
		store := &RedisStore{prefix: "test"}
		if store.Has("key") {
			t.Error("Has() should return false for unimplemented driver")
		}
	})
}
...
func TestRedisStore_GetPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			store := &RedisStore{prefix: tt.prefix}
			if got := store.GetPrefix(); got != tt.want {
				t.Errorf("GetPrefix() = %v, want %v", got, tt.want)
			}
		})

...
func (genHandlerCmd) run(a *App, args []string) error {
	...
	return console.GenHandler(args[0], opts)
}
...
func (genModelCmd) run(a *App, args []string) error {
	...
	return console.GenModel(args[0], opts)
}
...
func (genMiddlewareCmd) run(a *App, args []string) error {
	...
	return console.GenMiddleware(args[0], console.GenMiddlewareOptions{Dir: dir})
}
...
func (genEventCmd) run(a *App, args []string) error {
	...
	return console.GenEvent(args[0], console.GenEventOptions{Dir: dir})
}
...
func (genListenerCmd) run(a *App, args []string) error {
	...
	return console.GenListener(args[0], console.GenListenerOptions{Dir: dir})
}
...
func (genJobCmd) run(a *App, args []string) error {
	...
	return console.GenJob(args[0], console.GenJobOptions{Dir: dir})
}
...
func (genMailCmd) run(a *App, args []string) error {
	...
	return console.GenMail(args[0], console.GenMailOptions{Dir: dir})
}
...
func (genNotificationCmd) run(a *App, args []string) error {
	...
	return console.GenNotification(args[0], console.GenNotificationOptions{Dir: dir})
}
...
func (genResourceCmd) run(a *App, args []string) error {
	...
	return console.GenResource(args[0], console.GenResourceOptions{Dir: dir})
}
...
func (genPolicyCmd) run(a *App, args []string) error {
	...
	return console.GenPolicy(args[0], console.GenPolicyOptions{Dir: dir})
}
...
func (genModuleCmd) run(a *App, args []string) error {
	...
	return console.GenModule(args[0], console.GenModuleOptions{Dir: dir})
}
...
func (genCommandCmd) run(a *App, args []string) error {
	...
	return console.GenCommand(args[0], console.GenCommandOptions{Dir: dir})
}

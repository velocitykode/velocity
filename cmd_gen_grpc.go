...
func (genGRPCServiceCmd) run(a *App, args []string) error {
	...
	return console.GenGRPCService(name, opts)
}
...
func parseGenGRPCServiceArgs(args []string) (string, console.GenGRPCServiceOptions, error) {
	var (
		name string
		opts console.GenGRPCServiceOptions
	)
...
func (genGRPCRPCCmd) run(a *App, args []string) error {
	...
	return console.GenGRPCRPC(args[0], args[1], opts)
}
...
func parseGenGRPCRPCArgs(args []string) (console.GenGRPCRPCOptions, error) {
	var opts console.GenGRPCRPCOptions

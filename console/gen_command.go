...
// GenCommandOptions holds flags for the gen command command.
type GenCommandOptions struct {
	Dir string // --dir output directory override (default internal/commands)
}

// GenCommand generates a new command file from a stub template.
func GenCommand(name string, opts GenCommandOptions) error {

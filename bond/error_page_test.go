...
func TestBond_ReloadLocation(t *testing.T) {
	tests := []struct {
		...
		{name: "POSTSameHostReferer", method: http.MethodPost, target: "/posts", host: "example.com", referer: "http://example.com/posts/new?draft=1", want: "/posts/new?draft=1"},
		{name: "POSTSameHostRefererRoot", method: http.MethodPost, target: "/posts", host: "example.com", referer: "http://example.com", want: "/"},
		{name: "POSTSameHostRefererDoubleSlashPath", method: http.MethodPost, target: "/posts", host: "example.com", referer: "http://example.com//evil.test/x", want: "/"},
		{name: "POSTCrossOriginReferer", method: http.MethodPost, target: "/posts", host: "example.com", referer: "https://evil.test/phish", want: "/"},
		{name: "POSTAllowlistedReferer", method: http.MethodPut, target: "/posts", host: "internal:8080", referer: "https://app.example.com/posts/2/edit", allowlist: []string{"app.example.com"}, want: "/posts/2/edit"},

...
// GenGRPCServiceOptions holds flags for the gen grpc service command. The
...
type GenGRPCServiceOptions struct {
	...
	// wiring rather than the generated internal/modules/grpc_module.go.
	NoModule bool
}
...
// GenGRPCService scaffolds a new gRPC service: proto file, server impl, and
...
// marker comments.
func GenGRPCService(name string, opts GenGRPCServiceOptions) error {
...
// without re-checking.
func resolveGRPCScaffold(name string, opts GenGRPCServiceOptions) (grpcScaffold, error) {
	var sc grpcScaffold

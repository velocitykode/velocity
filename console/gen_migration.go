...
// GenMigrationOptions holds flags for the gen migration command.
type GenMigrationOptions struct {
...
// GenMigration generates a new timestamped migration file from a stub template.
func GenMigration(name string, opts GenMigrationOptions) error {
